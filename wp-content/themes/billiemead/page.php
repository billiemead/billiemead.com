...
get_header(); carbon_print_menu();
	...
	$sidebar = carbon_convert_to_class(get_post_meta($post->ID, 'sidebars_available_value', true));
	switch (get_post_meta($post->ID, 'sidebar_for_default_value', true)){
						...
						<?php
							if ((function_exists('vc_is_inline') && vc_is_inline()) || is_preview() || ( function_exists('is_checkout') && is_checkout() )){
								...
								if (post_password_required()) echo get_the_password_form();
									...
									$content_post = get_post($carbon_thisPostID);
									...
									$shortcodes_custom_css = get_post_meta( $carbon_thisPostID, '_wpb_shortcodes_custom_css', true );
		...
		case "left":
			...
			<div class="master_container master_container_bgwhite" >
				<div class="container">
					...
					?>
					<section class="page_content right col-xs-12 col-md-9 <?php if (post_password_required()) echo ' border-none '; ?>" id="section-<?php echo esc_attr(get_the_ID()); ?>" >
						<?php
							if ((function_exists('vc_is_inline') && vc_is_inline()) || is_preview() || ( function_exists('is_checkout') && is_checkout() )){
								wp_reset_postdata();
								the_content();
		...
		case "right":
			...
			<div class="master_container master_container_bgwhite" >
				<div class="container">
					<section class="page_content left col-xs-12 col-md-9 <?php if (post_password_required()) echo ' border-none '; ?>" id="section-<?php echo get_the_ID(); ?>" >
						<?php
							if ((function_exists('vc_is_inline') && vc_is_inline()) || is_preview() || ( function_exists('is_checkout') && is_checkout() )){
								wp_reset_postdata();
								the_content();
