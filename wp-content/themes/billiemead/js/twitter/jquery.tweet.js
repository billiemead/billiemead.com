...
(function (factory) {
    ...
    jQuery.fn.destweet = function(o){
        var s = jQuery.extend({
            modpath: window.carbonOptions.templatepath+"js/twitter/",                     // [string]   relative URL to Tweet.js mod (see https://github.com/StanScates/Tweet.js-Mod)
            ...
            jQuery(widget).off("tweet:load").on("tweet:load", function(){
				...
				jQuery.ajax({
					...
					data: {
						...
						dataType: "JSON",
						templatepath: window.carbonOptions.homePATH,
						security: jQuery('#carbon-theme-twitter').val()
			        },
