					    		...
					    		case "image":
									...
									?>
										<div class="featured-image">
											...
											<img alt="<?php echo esc_attr(get_the_title()); ?>" src="<?php echo esc_url(wp_get_attachment_url( get_post_thumbnail_id($postid))); ?>" title="<?php esc_attr(get_the_title()); ?>"/>
