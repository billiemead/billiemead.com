var upperPageOptions={
	...
	init:function(){
		...
		if (jQuery('#carbon_enable_breadcrumbs_value').length){
			jQuery('#carbon_enable_breadcrumbs_value').change(function(){
				if (jQuery(this).val() == "yes"){
					jQuery('#carbon_breadcrumbs_margin_top_noncename').parent().removeClass('optoff').css('display','block');
				} else {
					jQuery('#carbon_breadcrumbs_margin_top_noncename').parent().addClass('optoff').css('display','none');
				}
			}).trigger('change');
		}
		...
		if (jQuery('#carbon_enable_custom_pagetitle_options_value').length){
			jQuery('#carbon_enable_custom_pagetitle_options_value').change(function(){
				if (jQuery('#carbon_enable_custom_pagetitle_options_value').val() == 'yes'){
					jQuery('#carbon_header_type_value').closest('.option-container').css('display','block');
					showElements(jQuery('#carbon_enable_custom_pagetitle_options_value').closest('.option-container').nextUntil(jQuery('.underconstructionoptions')).removeClass('hiddenoption'), 0);
					jQuery('#carbon_header_type_value').trigger('change');
					jQuery('#carbon_enable_breadcrumbs_value').trigger('change');
				} else {
					hideElements(jQuery('#carbon_enable_custom_pagetitle_options_value').closest('.option-container').nextUntil(jQuery('.underconstructionoptions')).addClass('hiddenoption'), 0);
				}
			}).trigger('change');
		}
		...
		if (jQuery('#carbon_enable_custom_header_options_value').length){
			jQuery('#carbon_enable_custom_header_options_value').change(function(){
				if (jQuery('#carbon_enable_custom_header_options_value').val() == 'yes'){
					showElements( jQuery('#carbon_custom_header_pre_value').closest('.option-container').add( jQuery('#carbon_custom_header_after_value').closest('.option-container') ).add( jQuery('#carbon_enable_website_loading_value').closest('.option-container') ).add( jQuery('#carbon_content_to_the_top_value').closest('.option-container') ).removeClass('hiddenoption optoff') , 0);
				} else {
					hideElements( jQuery('#carbon_custom_header_pre_value').closest('.option-container').add( jQuery('#carbon_custom_header_after_value').closest('.option-container') ).add( jQuery('#carbon_enable_website_loading_value').closest('.option-container') ).add( jQuery('#carbon_content_to_the_top_value').closest('.option-container') ).addClass('hiddenoption') , 0);
				}
			}).trigger('change');

		}
				
		if (jQuery('#carbon_header_type_value').length){
			if (jQuery('#carbon_header_type_value').val() != 'without'){
				if (jQuery('#carbon_hide_pagetitle_value').val() == 'yes'){
					jQuery('#carbon_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('#carbon_header_text_margin_top_noncename').parent().next()).not('script').css('display','block');
				} else jQuery('#carbon_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('.underconstructionoptions')).css('display','none');
			}
			jQuery('#carbon_hide_pagetitle_value').change(function(){
				if (jQuery('#carbon_header_type_value').val() != 'without'){
					if (jQuery('#carbon_hide_pagetitle_value').val() == 'yes'){
						jQuery('#carbon_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('#carbon_header_text_margin_top_noncename').parent().next()).not('script').css('display','block');
					} else jQuery('#carbon_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('#carbon_header_text_margin_top_noncename').parent().next()).css('display','none');
				}
			});
		}
		...
		if (jQuery('#carbon_header_type_value').length){
			if (jQuery('#carbon_header_type_value').val() != 'without'){
				if (jQuery('#carbon_hide_sec_pagetitle_value').val() == 'yes'){
					jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('#carbon_header_text_margin_top_noncename').parent().next()).not('script').css('display','block');
				} else jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('#carbon_header_text_margin_top_noncename').parent().next()).css('display','none');
			}
		}
		
		if (jQuery('#carbon_hide_sec_pagetitle_value').length){
			jQuery('#carbon_hide_sec_pagetitle_value').change(function(){
				if (jQuery('#carbon_header_type_value').val() != 'without'){
					if (jQuery('#carbon_hide_sec_pagetitle_value').val() == 'yes'){
						jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('.breadcrumboptions')).not('script').css('display','block');
					} else jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('.breadcrumboptions')).css('display','none');
				}
			});
		}
		
		if (jQuery('#carbon_pagetitle_image_overlay_value').length){
			jQuery('#carbon_pagetitle_image_overlay_value').change(function(){
				if (jQuery(this).val() == "on"){
					jQuery('#carbon_pagetitle_overlay_type_value').closest('.option-container')
						.add(jQuery('#carbon_pagetitle_overlay_opacity_noncename').closest('.option-container'))
					.css('display','block');
					jQuery('#carbon_pagetitle_overlay_type_value').change();
				} else {
					jQuery('#carbon_pagetitle_overlay_type_value').closest('.option-container').nextUntil(jQuery('#carbon_pagetitle_overlay_opacity_slider').closest('.option-container').next()).addBack()
						.add(jQuery('#carbon_pagetitle_overlay_pattern_value').closest('.option-container'))
					.css('display','none');
				}
			});
		}
		
		if (jQuery('#carbon_pagetitle_overlay_type_value').length){
			jQuery('#carbon_pagetitle_overlay_type_value').change(function(){
				if (jQuery(this).val() == "color"){
					jQuery('#carbon_pagetitle_overlay_color').closest('.option-container').css('display','block');
					jQuery('#carbon_pagetitle_overlay_pattern_noncename').closest('.option-container').css('display','none');
				} else {
					jQuery('#carbon_pagetitle_overlay_color').closest('.option-container').css('display','none');
					jQuery('#carbon_pagetitle_overlay_pattern_noncename').closest('.option-container').css('display','block');
				}
			});
		}
		
		if (jQuery('#carbon_header_type_value').length){
			jQuery('#carbon_header_type_value').change(function(){
				switch (jQuery('#carbon_header_type_value').val()){
					case "without":
						jQuery('#carbon_header_image_noncename').closest('.option-container').nextUntil(jQuery('#carbon_breadcrumbs_margin_top_noncename').closest('.option-container')).add(jQuery('#carbon_breadcrumbs_margin_top_noncename').closest('.option-container')).add(jQuery('#carbon_header_image_noncename').closest('.option-container')).css('display','none');	
					break;
					case "color":
						jQuery('#carbon_header_image_noncename').closest('.option-container')
							.add(jQuery('#carbon_header_pattern_noncename').closest('.option-container'))
							.add(jQuery('#carbon_header_custom_pattern_noncename').closest('.option-container'))
							.add(jQuery('#carbon_banner_slider_value').closest('.option-container'))
						.css('display','none');
						jQuery('#carbon_header_color_noncename').closest('.option-container').add(jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#carbon_hide_pagetitle_value').closest('.option-container'))
							.add(jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#carbon_hide_pagetitle_value').closest('.option-container').prev())
							.add(jQuery('#carbon_header_text_alignment_noncename').closest('.option-container'))
							.add(jQuery('#carbon_header_height_noncename').closest('.option-container'))
							.add(jQuery('#carbon_header_color_opacity_noncename').closest('.option-container'))
							.add(jQuery('#carbon_page_title_padding_noncename').closest('.option-container'))
							.add(jQuery('.breadcrumboptions').nextUntil(jQuery('.underconstructionoptions')).addBack())
						.css('display','block');
						
						jQuery('#carbon_pagetitle_image_parallax_value').closest('.option-container').nextUntil(jQuery('#carbon_pagetitle_overlay_opacity_noncename').closest('.option-container').next()).addBack().css('display','none');
						jQuery('#carbon_pagetitle_image_parallax_value').closest('.option-container').css('display','block');
						jQuery('#carbon_hide_sec_pagetitle_value').add(jQuery('#carbon_hide_pagetitle_value')).add(jQuery('#carbon_enable_breadcrumbs_value')).trigger('change');
					break;
					case "image":
						jQuery('#carbon_header_color_noncename').closest('.option-container')
							.add(jQuery('#carbon_header_pattern_noncename').closest('.option-container'))
							.add(jQuery('#carbon_header_custom_pattern_noncename').closest('.option-container'))
							.add(jQuery('#carbon_banner_slider_value').closest('.option-container'))
							.add(jQuery('#carbon_header_color_opacity_noncename').closest('.option-container'))
						.css('display','none');
						jQuery('#carbon_header_image_noncename').closest('.option-container').add(jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#carbon_hide_pagetitle_value').closest('.option-container'))
							.add(jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#carbon_hide_pagetitle_value').closest('.option-container').prev())
							.add(jQuery('#carbon_header_text_alignment_noncename').closest('.option-container'))
							.add(jQuery('#carbon_header_height_noncename').closest('.option-container'))
							.add(jQuery('#carbon_page_title_padding_noncename').closest('.option-container'))
						...
						// erererererere
						jQuery('#carbon_pagetitle_image_parallax_value').closest('.option-container').add(jQuery('#carbon_pagetitle_image_overlay_value').closest('.option-container')).css('display','block');
						jQuery('#carbon_pagetitle_image_overlay_value').change();
						
					break;
					case "pattern":
						jQuery('#carbon_header_image_noncename').closest('.option-container')
							.add(jQuery('#carbon_header_color_noncename').closest('.option-container'))
							.add(jQuery('#carbon_banner_slider_value').closest('.option-container'))
							.add(jQuery('#carbon_header_custom_pattern_noncename').closest('.option-container'))
							.add(jQuery('#carbon_header_color_opacity_noncename').closest('.option-container'))
						.css('display','none');
						jQuery('#carbon_header_pattern_noncename').closest('.option-container')
							.add(jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#carbon_hide_pagetitle_value').closest('.option-container'))
							.add(jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#carbon_hide_pagetitle_value').closest('.option-container').prev())
							.add(jQuery('#carbon_header_text_alignment_noncename').closest('.option-container'))
							.add(jQuery('#carbon_header_height_noncename').closest('.option-container'))
							.add(jQuery('#carbon_page_title_padding_noncename').closest('.option-container'))
					...
					case "custom_pattern":
						jQuery('#carbon_header_image_noncename').closest('.option-container')
							...
							.add(jQuery('#carbon_header_color_opacity_noncename').closest('.option-container'))
						.css('display','none');
						jQuery('#carbon_header_custom_pattern_noncename').closest('.option-container')
							.add(jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#carbon_hide_pagetitle_value').closest('.option-container'))
							.add(jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#carbon_hide_pagetitle_value').closest('.option-container').prev())
							.add(jQuery('#carbon_header_text_alignment_noncename').closest('.option-container'))
							.add(jQuery('#carbon_header_height_noncename').closest('.option-container'))
					...
					case "banner":
						...
						jQuery('#carbon_banner_slider_value').closest('.option-container').add(jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#carbon_hide_pagetitle_value').closest('.option-container'))
							.add(jQuery('#carbon_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#carbon_hide_pagetitle_value').closest('.option-container').prev())
							.add(jQuery('#carbon_header_text_alignment_noncename').closest('.option-container'))
							.add(jQuery('#carbon_header_height_noncename').closest('.option-container'))
							.add(jQuery('.breadcrumboptions').nextUntil(jQuery('.underconstructionoptions')).addBack())
		...
		if (jQuery('#post_type').length > 0){
			if (jQuery('#post_type').val() == "page"){
				...
				jQuery('#sidebars_available_value').add(jQuery('#sidebars_available_value').siblings()).wrapAll('<div class="carbon_sidebars_available" style="display:none;"/>');
				jQuery('#pageparentdiv.postbox .inside').css('display','inline-block').append(jQuery('.carbon_sidebars_available'));
				jQuery('#pageparentdiv.postbox .inside .des_layouts').each(function(){
					...
					if (jQuery('#pageparentdiv.postbox .inside .des_layouts.selected').attr('title') === "none"){
						jQuery('#pageparentdiv.postbox .inside .carbon_sidebars_available').css('display','none');
					} else {
						jQuery('#pageparentdiv.postbox .inside .carbon_sidebars_available').css('display','block');
					}
			...
			if (jQuery('#post_type').val() == "post"){
				...
				jQuery('input[name="enable_post_custom_sidebar_layout"]').change(function(){
					if (jQuery(this).is(':checked')) {
						...
						if (jQuery('#upper_post_layout.postbox .inside .des_layouts.selected').attr('title') === "none"){
							jQuery('#upper_post_layout.postbox .inside .carbon_sidebars_available').css('display','none');
						} else {
							jQuery('#upper_post_layout.postbox .inside .carbon_sidebars_available').css('display','block');
						}
						jQuery('#enable_post_custom_sidebar_layout_value').val("true");
					} else {
						jQuery('.des_layouts').add(jQuery('.carbon_sidebars_available')).css('display','none');
						jQuery('#enable_post_custom_sidebar_layout_value').val("false");
					}
				});
				
				if (jQuery('#enable_post_custom_sidebar_layout_value').val() == "true"){
					jQuery('.des_layouts').add(jQuery('.carbon_sidebars_available')).css('display','block');
				...
				jQuery('#sidebars_available_value').add(jQuery('#sidebars_available_value').siblings()).wrapAll('<div class="carbon_sidebars_available" style="display:none;"/>');
				jQuery('#upper_post_layout.postbox .inside').css('display','inline-block').append(jQuery('.carbon_sidebars_available'));
		...
		upperPageOptions.updateHomeStyleOptions();
		//if (jQuery('#page_template').length) jQuery('#page_template').trigger('change');
		if (jQuery('#carbon_header_type_value').length) jQuery('#carbon_header_type_value').trigger('change');
...
showElements(jQuery('#introLogo_noncename').parent().add(jQuery('#introLogo_noncename').parent().nextUntil(jQuery('#secondaryTitle_noncename').parent())),0);
	...
	updateCustomPageOpts: function(){
		...
		switch (page_template_element.val()){
			...
			case "one-page-template.php":
				...
				toggleHomepageOptions("hide");
				jQuery('#pageparentdiv.postbox .inside > h4, #pageparentdiv.postbox .inside > .carbon_sidebars_available, #pageparentdiv.postbox .inside > div.des_layouts').css('display','none');
				jQuery('#underconstruction_rev_value').closest('.option-container').add(jQuery('#underconstruction_rev_value').closest('.option-container').prev()).css('display','none');
			...
			case "template-home.php":
				...
				togglePageOptions("hide");
				jQuery('.blogoptions').nextUntil(jQuery('.pagetitleoptions')).addBack().css('display','none');
				jQuery('#carbon_enable_custom_header_options_value').closest('.option-container').css('display','block').removeClass('hiddenoption');
				upperPageOptions.updateHomeStyleOptions();
				jQuery('#carbon_enable_custom_header_options_value').trigger('change');
			break;
	...
	updatePostTypeOpts: function(){
		...
		switch(jQuery('#posttype_value').val()){
			case "image":
				jQuery('#carbon_display_featured_image_value').parent().removeClass('optoff');
				showElements(jQuery('#carbon_display_featured_image_value').parent(),0);
			break;
			case "slider":
...
function togglePageOptions(action){
	switch (action){
		case "show":
			...
			jQuery('#carbon_enable_custom_pagetitle_options_value').trigger('change');
			jQuery('#carbon_enable_custom_header_options_value').trigger('change');
			break;
		case "hide":
