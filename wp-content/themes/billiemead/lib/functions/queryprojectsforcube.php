...
function upper_query_projects_for_cube(){
	...
	if (!wp_verify_nonce($_POST['security'],'carbon-theme-projects-cube')) return;
	...
	if (isset($_POST['upper_action'])){
		switch($_POST['upper_action']){
			case "import":
				...
				$portfoliotype = get_option("carbon_portfolio_permalink") ? get_option("carbon_portfolio_permalink") : "portfolio";
					...
					if ($counter < $nprojs){
						...
						if (isset($_POST['categories'])){
							if (!$categories) {
								...
								$filters_nicenames = esc_html__("Uncategorized", "carbon");
