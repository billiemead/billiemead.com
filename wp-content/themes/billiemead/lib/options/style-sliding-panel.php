<?php
	...
	array(
		...
		"id" => "carbon_sliding_panel_background_color",
		"type" => "color",
		"std" => "ffffff"
	),
	...
	array(
		"name" => "Font",
		"id" => "carbon_sliding_panel_titles_font",
		"type" => "select",
	...
	array(
		"name" => "Font Color",
		"id" => "carbon_sliding_panel_titles_color",
		"type" => "color",
		"std" => "595959"
	),
	...
	array(
		"name" => "Font Size",
		"id" => "carbon_sliding_panel_titles_font_size",
		"type" => "slider",
		"std" => "14px",
	...
	array(
		"name" => "Font",
		"id" => "carbon_sliding_panel_links_font",
		"type" => "select",
		"options" => $carbon_fonts_array,
		"desc" => 'You can select one of the fonts that the theme goes with or you can add google fonts (Style Options > Fonts).',
		"std" => "Helvetica Neue"
	...
	array(
		"name" => "Font Color",
		"id" => "carbon_sliding_panel_links_color",
		"type" => "color",
		"std" => "595959"
	),
	...
	array(
		...
		"id" => "carbon_sliding_panel_links_color_hover",
		"type" => "color",
		"std" => get_option('carbon_style_color')
	),
	
	array(
		"name" => "Font Size",
		"id" => "carbon_sliding_panel_links_font_size",
		"type" => "slider",
		"std" => "14px",
		"desc" => "Change the size of your menu font."
	),
	...
	array(
		"name" => "Font",
		"id" => "carbon_sliding_panel_p_font",
		"type" => "select",
		"options" => $carbon_fonts_array,
		"desc" => 'You can select one of the fonts that the theme goes with or you can add google fonts (Style Options > Fonts).',
		"std" => "Helvetica Neue"
	...
	array(
		"name" => "Font Color",
		"id" => "carbon_sliding_panel_p_color",
		"type" => "color",
		"std" => "595959"
	),
	...
	array(
		"name" => "Font Size",
		"id" => "carbon_sliding_panel_p_font_size",
		"type" => "slider",
		"std" => "14px",
		"desc" => "Change the size of your menu font."
	),
