		...
		foreach($custom_page->fields as $field){
			...
			switch($field['type']){
				...
				case 'upload':
					...
					$carbon_admin_inline_script .= '
						jQuery(document).ready(function(){ "use strict";
							carbonOptions.loadUploader(jQuery("div#'.esc_js($button_id).'"), "'.CARBON_UTILS_URL.'upload-handler.php", "'.CARBON_UPLOADS_URL.'");
						});
					';
				...
				case 'upload2':
					...
					$carbon_admin_inline_script .= '
						jQuery(document).ready(function(){ "use strict";
							carbonOptions.loadUploader(jQuery("div#'.esc_js($button_id).'2"), "'.CARBON_UTILS_URL.'upload-handler.php", "'.CARBON_UPLOADS_URL.'");
						});
					';
					wp_add_inline_script('carbon-admin', $carbon_admin_inline_script, 'after');
